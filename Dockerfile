...
FROM ${ SPOTIFY_ACCESS_KEY }
FROM ${ SPOTIFY_SECRET_KEY }
FROM ${ IBM_DISCOVERY_KEY }
FROM ${ IBM_DISCOVERY_URL }
FROM ${ IBM_DISCOVERY_ENVID }
FROM ${ IBM_DISCOVERY_COLID }
FROM ${ IBM_TONE_KEY }
FROM ${ IBM_TONE_URL }
FROM ${ AWS_ACCESS_KEY }
FROM ${ AWS_SECRET_KEY }
FROM ${ GENIUS_TOKEN }
FROM ${ TWITTER_ACCESS_KEY }
FROM ${ TWITTER_SECRET_KEY }
FROM ${ TWITTER_BEARER_TOKEN }
FROM ${ TWITTER_ACCESS_TOKEN }
FROM ${ TWITTER_ACCESS_SECRET }
